...
//                    new UsernamePasswordAuthenticationToken(requestMap.get("correo"), requestMap.get("password"))
//            );
...
//                            String.valueOf(customerDetailsService.getRepresentanteDetail().getTiposUsuarios()));
